...
export function PageSwitcher() {
  ...
  async function connect() {
    ...
    try {
      ...
      if (window.museClient && window.museClient.eegReadings) {
        window.rawZippedData$ = zipSamples(window.museClient.eegReadings).pipe(
  ...
  async function handleUnsubscribe() {
    if (window.rawSubscription$ || window.spectraSubscription$) {
      window.rawSubscription$.unsubscribe();
      window.spectraSubscription$.unsubscribe();
    }
  }
