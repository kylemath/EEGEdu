...
import sketchPpg from './sketchPpg'
...
export function buildPipe(Settings) {
  ...
  window.subscriptionPpg = null;

  // Build Pipe
  window.pipePpg$ = zipSamples(window.source.eegReadings$).pipe(
    bandpassFilter({ 
...
export function setup(setData, Settings) {
  ...
  if (window.multicastPpg$) {
    window.subscriptionPpg = window.multicastPpg$.subscribe(data => {
      setData(ppgData => {
